...
public class DashClockWeatherExtension extends DashClockExtension {
    private static final Uri URI_BASE = Uri.parse("content://com.codewithgolap.samadhan.authority");
    ...
    private String localize(SharedPreferences sp, String preferenceKey, String defaultValueKey) {
        return MainActivity2.localize(sp, this, preferenceKey, defaultValueKey);
    }
