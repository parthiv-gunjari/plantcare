...
import com.codewithgolap.samadhan.AlarmReceiver;
import com.codewithgolap.samadhan.R;
import com.codewithgolap.samadhan.adapters.ViewPagerAdapter;
import com.codewithgolap.samadhan.adapters.WeatherRecyclerAdapter;
import com.codewithgolap.samadhan.fragments.AboutDialogFragment;
import com.codewithgolap.samadhan.fragments.AmbiguousLocationDialogFragment;
import com.codewithgolap.samadhan.fragments.RecyclerViewFragment;
import com.codewithgolap.samadhan.models.Weather;
import com.codewithgolap.samadhan.tasks.GenericRequestTask;
import com.codewithgolap.samadhan.tasks.ParseResult;
import com.codewithgolap.samadhan.tasks.TaskOutput;
import com.codewithgolap.samadhan.utils.Formatting;
import com.codewithgolap.samadhan.utils.UI;
import com.codewithgolap.samadhan.utils.UnitConvertor;
import com.codewithgolap.samadhan.widgets.AbstractWidgetProvider;
import com.codewithgolap.samadhan.widgets.DashClockWeatherExtension;
...
public class MainActivity2 extends BaseActivity implements LocationListener, CheckRefreshClickListener {
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                new FindCitiesByNameTask(getApplicationContext(),
                        MainActivity2.this, progressDialog).execute("city", query);
                return false;
            }
    ...
    private void preloadUVIndex() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(MainActivity2.this);
    ...
    private void searchCities() {
        ...
        alert.setPositiveButton(R.string.dialog_ok, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (!result.isEmpty()) {
                    new FindCitiesByNameTask(getApplicationContext(),
                            MainActivity2.this, progressDialog).execute("city", result);
                }
            }
        });
...
//        }
    ...
    private ParseResult parseTodayJson(String result) {
        try {
            ...
            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(MainActivity2.this).edit();
    ...
    private void updateTodayWeatherUI() {
        ...
        todayIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity2.this, GraphActivity.class);
...
//        }
    ...
    class TodayWeatherTask extends GenericRequestTask {
        public TodayWeatherTask(Context context, MainActivity2 activity, ProgressDialog progressDialog) {
        ...
        protected void onPostExecute(TaskOutput output) {
            ...
            // Update widgets
            AbstractWidgetProvider.updateWidgets(MainActivity2.this);
            DashClockWeatherExtension.updateDashClock(MainActivity2.this);
        }
    ...
    class LongTermWeatherTask extends GenericRequestTask {
        public LongTermWeatherTask(Context context, MainActivity2 activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class FindCitiesByNameTask extends GenericRequestTask {
        ...
        public FindCitiesByNameTask(Context context, MainActivity2 activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
...
//                saveLocation(reader.getString("id"));
    ...
    class ProvideCityNameTask extends GenericRequestTask {
        ...
        public ProvideCityNameTask(Context context, MainActivity2 activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class TodayUVITask extends GenericRequestTask {
        public TodayUVITask(Context context, MainActivity2 activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
